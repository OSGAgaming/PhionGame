...
namespace QueefCord.Core.Graphics
{
	public class QuadMesh : Triangles
	{
		...
		public QuadMesh(Vector2 v1, Vector2 v2, Vector2 v3, Vector2 v4, Color color, string layer = "Default", Texture2D texture = null, Effect effect = null) : base(4, 6, layer, texture, effect)
		{
			Construct(v1, v2, v3,v4, color);
		}

		public void Construct(Vector2 v1, Vector2 v2, Vector2 v3, Vector2 v4, Color color)
        {
