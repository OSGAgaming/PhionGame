...
namespace QueefCord.Core.Tiles
{
    public partial class TileManager : IUpdate, ISerializable
    {
        ...
        [JsonIgnore]
        public static Dictionary<int, string> TileTextures = new Dictionary<int, string>();
        [JsonIgnore]
        ...
        public static int drawResolution = 8;
        public static int frameResolution = 8;
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (PlaceMode)
            {
                ...
                {
                    ActiveAtlas = (short)((ActiveAtlas + 1) % TileTextures.Count);
                    Logger.NewText("Atlas switched to: " + TileTextures[ActiveAtlas]);
                }
            }
